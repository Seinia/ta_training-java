package com.epam.training.vladyslav_yatsevilov.final_task.page;
...
public class SauceDemoDashboardPage extends AbstractPage {
    ...
    public String getLogoText(){
        String title = new WebDriverWait(driver, WAIT_TIMEOUT_SECONDS)
                .until(ExpectedConditions.visibilityOf(logo))
                .getText();
        log.info("Swag labs title is: {}", title);
        return title;
    }
}
