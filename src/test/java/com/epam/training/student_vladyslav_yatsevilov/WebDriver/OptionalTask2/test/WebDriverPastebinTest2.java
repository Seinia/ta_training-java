...
import com.epam.training.student_vladyslav_yatsevilov.WebDriver.OptionalTask2.service.PasteService2;
...
public class WebDriverPastebinTest2 extends BaseTest {
    ...
    public void commonSearchTestResultsAreNotEmpty(){
        Paste2 paste = PasteService2.getPasteDataFromProperties();
